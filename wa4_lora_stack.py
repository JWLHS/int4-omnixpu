"""
wa4_lora_stack.py — WA4 LoRA Stack v1.3
...
from .wa4_lora_loader import _resolve_qkv_slices, _make_bake_pre_hook
...
class WA4LoRAStack:
    ...
    def INPUT_TYPES(cls):
        # █ 原样保留 █
        inp = {"required": {"model": ("MODEL", {"tooltip": "From wa4ModelLoader"})}, "optional": {}}
        for i in range(1, 9):
...
NODE_CLASS_MAPPINGS = {"WA4LoRAStack": WA4LoRAStack}
NODE_DISPLAY_NAME_MAPPINGS = {"WA4LoRAStack": "WA4 LoRA Stack (up to 8)"}
